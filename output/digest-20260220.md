...
今日技术圈聚焦于 AI 对软件开发行业的深度重塑。Gemini 3.1 Pro 发布、SWE-bench 排行榜更新以及 prompt caching 技术的成熟，标志着 AI 编程工具正从实验走向生产级应用。与此同时，业界对 AI 冲击的讨论愈发激烈：Martin Fowler 预言专业前后端开发岗位将减少，Paul Ford 则在《纽约时报》撰文探讨 AI 颠覆已然到来的现实。在技术狂飙之外，开发者开始反思"品味"与"关怀"等人文价值在 AI 时代的新意义。
...
**ai**(4) · **llm**(2) · **benchmark**(2) · disruption(2) · programming(2) · productivity(2) · gemini(1) · pricing(1) · prompt-caching(1) · claude(1) · latency(1) · optimization(1) · industry-impact(1) · generalist(1) · specialist(1) · career(1) · swe-bench(1) · coding-agents(1) · evaluation(1) · hardware(1)
...
[A Few Rambling Observations on Care](https://blog.jim-nielsen.com/2026/observations-on-care/) — **blog.jim-nielsen.com** · 1 天前 · ⭐ 19/30
...
🏷️ ChatGPT, thinking, productivity

---

### 7. Is the Future “AWS for Everything”?

[Is the Future “AWS for Everything”?](https://www.construction-physics.com/p/is-the-future-aws-for-everything) — **construction-physics.com** · 21 小时前 · ⭐ 18/30
...
### 9. SWE-bench February 2026 leaderboard update
...
[AI is a NAND Maximiser](https://shkspr.mobi/blog/2026/02/ai-is-a-nand-maximiser/) — **shkspr.mobi** · 21 小时前 · ⭐ 21/30
...
🏷️ AI, hardware, supply chain, NVIDIA

---

## ⚙️ 工程

### 11. Quoting Thariq Shihipar
...
### 13. Stream of Consciousness Driven Development
...
🏷️ specification, pairing, development, methodology
...
### 15. Go Modules for Package Management Tooling

[Go Modules for Package Management Tooling](https://nesbitt.io/2026/02/19/go-modules-for-package-management-tooling.html) — **nesbitt.io** · 1 天前 · ⭐ 17/30
...
*生成于 2026-02-20 10:31 | 扫描 86 源 → 获取 2409 篇 → 精选 15 篇*
